...
import { DexihHub, eObjectType, SharedData, Table, DexihTableColumn, DexihColumnBase, InputColumn } from '../+hub/hub.models';
...
export class HubsService implements OnDestroy {
    ...
    previewDataUrl(hubKey: number, objectKey: number, objectType: eObjectType, inputColumns: InputColumn[], selectQuery: SelectQuery):
        Promise<string> {
