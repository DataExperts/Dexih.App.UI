...
export const deltaTypes = [
    ...
    {key: eDeltaType.AzureRowKey, name: 'Azure RowKey', dataType: null, defaultName: null, unique: true},
    {key: eDeltaType.AzurePartitionKey, name: 'Azure PartitionKey', dataType: null, defaultName: null, unique: true},
