...
//
	    ...
	    Task<string> BulkUploadFiles(string instanceId, long hubKey, DownloadUrl downloadUrl, string connectionId, long connectionKey, long fileFormatKey, ETypeCode formatType, bool loadData, bool includeFileName, bool includeFileDate, bool includeFileRowNumber, string fileName,
		    RepositoryManager database, CancellationToken cancellationToken);
	    ...
	    Task<string> ClearTables(string instanceId, long hubKey, DownloadUrl downloadUrl, DexihTable[] tables,
		    RepositoryManager repositoryManager, CancellationToken cancellationToken);
	    Task<string> PreviewTable(string instanceId, long hubKey, DownloadUrl downloadUrl, long tableKey, SelectQuery selectQuery, ViewConfig viewConfig, InputColumn[] inputColumns, InputParameters inputParameters, bool showRejectedData, bool isShared, RepositoryManager database, CancellationToken cancellationToken);
	    Task<string> PreviewTable(string instanceId, long hubKey, DownloadUrl downloadUrl, DexihTable hubTable, SelectQuery selectQuery, ViewConfig viewConfig, InputColumn[] inputColumns, InputParameters inputParameters, bool showRejectedData, RepositoryManager database, CancellationToken cancellationToken);
	    Task<string> PreviewDatalink(string instanceId, long hubKey, DownloadUrl downloadUrl, long datalinkKey, bool previewUpdates, SelectQuery selectQuery, ViewConfig viewConfig, InputColumn[] inputColumns, InputParameters parameters, bool isShared, RepositoryManager database, CancellationToken cancellationToken);
	    ...
	    Task<string> PreviewTransform(string instanceId, long hubKey, DownloadUrl downloadUrl, DexihDatalink hubDatalink, long datalinkTransformKey, SelectQuery selectQuery, ViewConfig viewConfig, InputColumn[] inputColumns, InputParameters parameters, RepositoryManager database, CancellationToken cancellationToken);
