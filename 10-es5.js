(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[10], {
    ...
    /***/
    function VQH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ONAe(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(UsersIndexComponent, [{
          ...
          value: function refreshUsers() {
            ...
            this.authService.post('/api/Admin/GetUsers', {
              ...
              _this._tableData.next(result);
            })["catch"](function (reason) {
              _this.dexihMessage.addMessage(reason);
            });
          }
        }, {
          key: "deleteUsers",
          value: function deleteUsers(users) {
            ...
            this.authService.confirmDialog('Delete users?', 'This action will delete users with the following emails: <p>' + emails.join('</p><p>') + '</p>  <p></p>Are you sure?').then(function (confirm) {
              if (confirm) {
                _this2.authService.post('/api/Admin/DeleteUsers', {
                  emails: emails
                }, 'Deleting users...').then(function () {
                  _this2.refreshUsers();
                })["catch"](function (reason) {
          ...
          value: function revokeUsers(users) {
            ...
            this.authService.confirmDialog('Revoke users?', 'This action will revoke users with the following emails: <p>' + emails.join('</p><p>') + '</p>  <p></p>Are you sure?').then(function (confirm) {
              if (confirm) {
                _this3.authService.post('/api/Admin/RevokeUsers', {
                  emails: users.map(function (c) {
                    return c.userName;
                  })
                }, 'Revoking users...').then(function () {
                  _this3.refreshUsers();
                })["catch"](function (reason) {
          ...
          value: function enableUsers(users) {
            ...
            this.authService.confirmDialog('Enable users?', 'This action will re-enable logins for users with the following emails: <p>' + emails.join('</p><p>') + '</p>  <p></p>Are you sure?').then(function (confirm) {
              if (confirm) {
                _this4.authService.post('/api/Admin/EnableUsers', {
                  emails: users.map(function (c) {
                    return c.userName;
                  })
                }, 'Enabling users...').then(function () {
                  _this4.refreshUsers();
                })["catch"](function (reason) {
          ...
          value: function reinviteUsers(users) {
            ...
            }, 'Inviting users...').then(function () {
              _this5.dexihMessage.addSuccessMessage('Emails have been sent to the selected users.');
            })["catch"](function (reason) {
    ...
    /***/
    function PLRb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function UserEditComponent_ng_template_6_Template(rf, ctx) {
        if (rf & 1) {
          var _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "d-button-save", 9);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserEditComponent_ng_template_6_Template_d_button_save_click_0_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserEditComponent_ng_template_6_Template_d_button_cancel_click_1_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);
      ...
      function UserEditComponent_form_8_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserEditComponent_li_11_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserEditComponent_li_11_Template_a_click_5_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10);

            var login_r8 = ctx.$implicit;

            var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r9.deleteLogin(login_r8);
          });
      ...
      var UserEditComponent = /*#__PURE__*/function () {
        function UserEditComponent(authService, formsService, route) {
        ...
        _createClass(UserEditComponent, [{
            ...
            try {
              this._subscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])([this.route.data, this.route.params]).subscribe(function (result) {
                ...
                if (_this6.action === 'new') {
                  var user = new _admin_models__WEBPACK_IMPORTED_MODULE_5__["UserAuthorization"]();

                  _this6.formsService.createDefault(user, user);
                } else {
                  _this6.email = params['userName'];
          ...
          value: function refreshForm() {
            ...
            this.authService.post('/api/Admin/GetUser', {
              ...
              _this7.logins = result.logins;

              _this7.formsService.createDefault(result, new _admin_models__WEBPACK_IMPORTED_MODULE_5__["UserAuthorization"]());
            })["catch"](function (reason) {
          ...
          value: function save() {
            ...
            if (this.action === 'new') {
              this.authService.post('/api/Admin/AddUsers', {
                users: [user],
                sendInvite: true
              }, 'Adding users...').then(function () {
                _this8.authService.navigateUp();
              })["catch"](function (reason) {
          ...
          value: function deleteLogin(login) {
            ...
            }, 'Removing external login...').then(function () {
              _this9.refreshForm();
            })["catch"](function (reason) {
    ...
    /***/
    function V0Sv(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function fV0Z(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function huSU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _admin_models__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../../admin.models */
      "fV0Z");
      /* harmony import */


      var _shared_ui_dexihMessage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../../shared/ui/dexihMessage */
      "aCdC");
      /* harmony import */
      ...
      var UsersInviteComponent = /*#__PURE__*/function () {
        function UsersInviteComponent(authService, formsService, route) {
        ...
        _createClass(UsersInviteComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this._routeDataSubscription = this.route.data.subscribe(function (data) {
              var inviteUsers = new _admin_models__WEBPACK_IMPORTED_MODULE_4__["Invites"]();
